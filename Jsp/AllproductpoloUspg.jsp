    ...
    <div class="container">
        ...
        <div class="product-list">
            <div class="product-grid">
                <!-- Product 1 -->
                <div class="product">
                    <img src="images/PoloMensBlazer.jpg" alt="Polo Product 1">
                    <h3><a href = "PU1.jsp">Mens Blazer</a></h3>
                    <p class="price">Rs 2,980</p>
                </div>

                <!-- Product 2 -->
                <div class="product">
                    <img src="images/PoloMensPants.jpg" alt="Polo Product 2">
                    <h3><a href = "PU2.jsp">Mens Pants</a></h3>
                    <p class="price">Rs 2,980</p>
                </div>

                <!-- Product 3 -->
                <div class="product">
                    <img src="images/PoloMensShirt.jpg" alt="Polo Product 3">
                    <h3><a href = "PU3.jsp">Mens Shirt</a></h3>
                    <p class="price">Rs 3,500</p>
                </div>

                <!-- Product 4 -->
                <div class="product">
                    <img src="images/PoloWomensBlazer.jpg" alt="Polo Product 4">
                    <h3><a href = "PU4.jsp">Womens Blazer</a></h3>
                    <p class="price">Rs 4,200</p>
                </div>

                <!-- Product 5 -->
                <div class="product">
                    <img src="images/PoloWomensDress.jpg" alt="Polo Product 5">
                    <h3><a href = "PU5.jsp">Womens Dress</a></h3>
                    <p class="price">Rs 1,800</p>
                </div>

                <!-- Product 6 -->
                <div class="product">
                    <img src="images/PoloWomensShirt.jpg" alt="Polo Product 6">
                    <h3><a href = "PU5.jsp">Womens Shirt</a></h3>
