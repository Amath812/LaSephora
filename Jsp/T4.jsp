...
<div class="container">
    <form action="InsertCartServlet" method="POST"> <!-- Change 'CartServlet' to your actual servlet name -->
        ...
        <div class="product-image">
            <img src="images/TommyWomensRomper.jpg" alt="TommyWomensRomper">
        </div>
           ...
           <!--<h1>Nike Mens Hoodie</h1>-->
            ...
            <div>
            	 <strong>Product Name:</strong>
            	 	...
            	 	<label>
                        <input style="border: none" type="text" name="name" value="Tommy Womens Romper" readonly>
                    </label>
                    <br><br>
                <strong>Size:</strong>
            ...
            <div class="price" id="price">
               <label><input style="border: none" type="Rs" name="price" value=" Rs 4,200 LKR" readonly></label> 
            </div>
