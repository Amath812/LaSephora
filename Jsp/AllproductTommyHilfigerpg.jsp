...
<div class="nav-bar">
    ...
    <div class="container">
        <div class="categories">
            <h2>Categories</h2>
            <ul>
                <li><a href = "AllproductNikepg.jsp">Nike</a></li>
                <li><a href = "AllproductpoloUspg.jsp">Polo Us</a></li>
                <li><a href = "AllproductTommyHilfigerpg.jsp">Tommy Hilfiger</a></li>
                <li><a href = "AllproductPradapg.jsp">Prada</a></li>
            </ul>
        </div>
        ...
        <div class="product-list">
            <div class="product-grid">
                <!-- Product 1 -->
                <div class="product">
                    <img src="images/TommyMensHoodie.jpg" alt="Tommy Product 1">
                    <h3><a href = "T1.jsp">Mens Hoddie</a></h3>
                    <p class="price">Rs 2,980</p>
                </div>

                <!-- Product 2 -->
                <div class="product">
                    <img src="images/TommyMensPants.jpeg" alt="Tommy Product 2">
                    <h3><a href = "T2.jsp">Mens Pants</a></h3>
                    <p class="price">Rs 2,980</p>
                </div>

                <!-- Product 3 -->
                <div class="product">
                    <img src="images/ToomyMnesShirt.jpg" alt="Tommy Product 3">
                    <h3><a href = "T3.jsp">Mens Shirt</a></h3>
                    <p class="price">Rs 3,500</p>
                </div>

                <!-- Product 4 -->
                <div class="product">
                    <img src="images/TommyWomensRomper.jpg" alt="Tommy Product 4">
                    <h3><a href = "T4.jsp">Womens Rompe</a></h3>
                    <p class="price">Rs 4,200</p>
                </div>

                <!-- Product 5 -->
                <div class="product">
                    <img src="images/TommyWomensPants.jpg" alt="Tommy Product 5">
                    <h3><a href = "T5.jsp">Womens Pants</a></h3>
                    <p class="price">Rs 1,800</p>
                </div>

                <!-- Product 6 -->
                <div class="product">
                    <img src="images/ToomyWomensShirt.jpg" alt="Tommy Product 6">
                    <h3><a href = "T6.jsp">Womens Shirt</a></h3>
