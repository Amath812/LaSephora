...
<div class="container">
    <form action="InsertCartServlet" method="POST"> <!-- Change 'CartServlet' to your actual servlet name -->
        ...
        <div class="product-image">
            <img src="images/NikeMensJoggers.png" alt="Nike Mens Joggers">
        </div>
           ...
           <!--<h1>Nike Mens Hoodie</h1>-->
            ...
            <div>
            	 <strong>Product Name:</strong>
            	 	...
            	 	<label>
                        <input style="border: none" type="text" name="name" value="Nike Mens Joggers" readonly>
                    </label>
                    <br><br>
                <strong>Size:</strong>
            ...
            <div class="price" id="price">
               <label><input style="border: none" type="Rs" name="price" value=" Rs 2,980 LKR" readonly></label> 
            </div>
