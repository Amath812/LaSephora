    ...
    <div class="container">
        ...
        <div class="product-list">
            <div class="product-grid">
                <!-- Product 1 -->
                <div class="product">
                    <img src="images/PradaMensShirt.jpg" alt="Prada Product 1">
                    <h3><a href = "P1.jsp">Mens Shirt</a></h3>
                    <p class="price">Rs 2,980</p>
                </div>

                <!-- Product 2 -->
                <div class="product">
                    <img src="images/PradaMensPants.jpg" alt="Prada Product 2">
                    <h3><a href = "P2.jsp">Mens Pants</a></h3>
                    <p class="price">Rs 2,980</p>
                </div>

                <!-- Product 3 -->
                <div class="product">
                    <img src="images/PradaMensJacket.jpg" alt="Prada Product 3">
                    <h3><a href = "P3.jsp">Mens Jacket</a></h3>
                    <p class="price">Rs 3,500</p>
                </div>

                <!-- Product 4 -->
                <div class="product">
                    <img src="images/PradaWomensSkirt.jpg" alt="Prada Product 4">
                    <h3><a href = "P4.jsp">Womens Skirt</a></h3>
                    <p class="price">Rs 4,200</p>
                </div>

                <!-- Product 5 -->
                <div class="product">
                    <img src="images/PradaWomensTop.jpg" alt="Prada Product 5">
                    <h3><a href = "P5.jsp">Womens Top</a></h3>
                    <p class="price">Rs 1,800</p>
                </div>

                <!-- Product 6 -->
                <div class="product">
                    <img src="images/ParadaWomensDress.jpg" alt="Prada Product 6">
                    <h3><a href = "P6.jsp">Womens Dress</a></h3>
