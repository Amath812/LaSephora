...
<div class = "formBody">
<form id="productForm" method="post" action="UpdateCartServlet">
        
         <div>
                <label for="productID">Product ID</label>
                <input type="text" id="productName" name="id" value="<%=id%>" readonly>
            </div>
            <div>
                <label for="productName">Product Name</label>
                <input type="text" id="productName" name="name" value="<%=name%>" readonly>
            </div>
            
            <div>
                <label for="ProductColor">Color</label>
               
                <select name="colour" id="ProductColor">
                
            	<option value="grey" value="<%=color%>">Grey</option> <!-- Placeholder option -->
            	<option value="black" value="<%=color%>">Black</option>
            	<option value="white" value="<%=color%>">White</option>
            	<option value="blue" value="<%=color%>">Blue</option>
            	<option value="green" value="<%=color%>">Green</option>
        </select>
            </div>
            <div >
                <!-- <label for="unitPrice">Size</label>
                <input type="text" id="size" name="size" step="1" value="" > -->
                
                <label for="ProductSize">Size</label>
        <select name="big" id="ProductSize">
            <option value="XS" value="<%=size%>">XS</option> <!-- Placeholder option -->
            <option value="S" value="<%=size%>">S</option>
            <option value="M" value="<%=size%>">M</option>
            <option value="L" value="<%=size%>">L</option>
            <option value="XL" value="<%=size%>">XL</option>
            <option value="XXL" value="<%=size%>">XXL</option>
        </select>
            </div>
            <div>
               <!--<label for="quantity">Quantity In Hand</label>
                <input type="text" id="quantity" name="quantity" min="0" value="" >-->
                <label for="ProductQuantity">Quantity</label>
                <input type="number" id="quantity" name="quantity" min="1" value="<%=quantity%>">
            </div>
            <div>
                <label for="ProductPrice">Price</label>
                <input type="text" id="productprice" name="price"  value="<%=price%>" readonly>
            </div>
            <div>
