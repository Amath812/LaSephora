    ...
    <div class="container">
        ...
        <div class="product-list">
            <div class="product-grid">
                <!-- Product 1 -->
                <div class="product">
                    <img src="images/NikeMensHoodie.png" alt="Nike Product 1">
                    <h3><a href = "Np1.jsp">Mens Hoddie</a></h3>
                    <p class="price">Rs 2,980</p>
                </div>

                <!-- Product 2 -->
                <div class="product">
                    <img src="images/NikeMensJoggers.png" alt="Nike Product 2">
                    <h3><a href = "Np2.jsp">Mens Joggers</a></h3>
                    <p class="price">Rs 2,980</p>
                </div>

                <!-- Product 3 -->
                <div class="product">
                    <img src="images/NikeMensShirt.png" alt="Nike Product 3">
                    <h3><a href = "Np3.jsp">Mens Shirt</a></h3>
                    <p class="price">Rs 3,500</p>
                </div>

                <!-- Product 4 -->
                <div class="product">
                    <img src="images/NikeWomensDress.jpg" alt="Nike Product 4">
                    <h3><a href = "Np4.jsp">Women Dress</a></h3>
                    <p class="price">Rs 4,200</p>
                </div>

                <!-- Product 5 -->
                <div class="product">
                    <img src="images/NikeWomensPant.png" alt="Nike Product 5">
                    <h3><a href = "Np5.jsp">Women Pant</a></h3>
                    <p class="price">Rs 1,800</p>
                </div>

                <!-- Product 6 -->
                <div class="product">
                    <img src="images/NikeWomensTank.png" alt="Nike Product 6">
                    <h3><a href = "Np6.jsp">Womens Tank</a></h3>
